...
class CFG:
    ...
    prev_model     =  './pretrained_models/swin_fold0_best_21.pth' # './pretrained_models/efficientnetv2_fold0_best_new_normalize.pth' #./swintransformer_b2_fold0_best_tokenizer_vi.pth'
