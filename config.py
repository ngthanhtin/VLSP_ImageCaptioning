...
class CFG:
    ...
    num_workers    = 4
    model_name     = 'swin'
    enc_size       = 1024 #efficientnetv2-m:2152 #efficientnetv2-s: 1792 # swin: 1024 #efficientnetb2: 1408
    samp_size      = 10
    ...
    prev_model     =  './pretrained_models/swin_fold0_best.pth' # './pretrained_models/efficientnetv2_fold0_best_new_normalize.pth' #./swintransformer_b2_fold0_best_tokenizer_vi.pth'
